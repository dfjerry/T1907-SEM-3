...
using System.Runtime.Serialization.Json; //thư viện runtime theo tgian thực, serialization json dùng đúng nó
using System.IO;
...
namespace Tutorial6.Models
{
    public class GetWeatherData
    {
        public async static Task<RootObject> getOpenWeather()
        {
            ...
            //bóc tách nội dung json, ReadAsStringAsync -> đọc
            var result = await response.Content.ReadAsStringAsync();
            // truyền object root vào để đọc ra
