#pragma checksum "C:\Users\Admin\source\repos\dfjerry\T1907-SEM-3\WeatherApp2\WeatherApp2\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "C3945DE91A7D12EB7004CE1C33E32359"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace WeatherApp2
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::WeatherApp2.Models.DailyForecast dataRoot;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 60 && columnNumber == 177)
                {
                    isobj6SourceDisabled = true;
                }
                else if (lineNumber == 61 && columnNumber == 91)
                {
                    isobj7TextDisabled = true;
                }
                else if (lineNumber == 62 && columnNumber == 124)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::WeatherApp2.Models.DailyForecast) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::WeatherApp2.Models.DailyForecast)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::WeatherApp2.Models.DailyForecast obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_Day(global::WeatherApp2.Models.Day obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature(global::WeatherApp2.Models.Temperature1 obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature_Maximum(global::WeatherApp2.Models.Maximum obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature_Minimum(global::WeatherApp2.Models.Minimum obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj11_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::WeatherApp2.Models.WeatherJSON dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 42 && columnNumber == 83)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::WeatherApp2.Models.WeatherJSON) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::WeatherApp2.Models.WeatherJSON)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::WeatherApp2.Models.WeatherJSON obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature(global::WeatherApp2.Models.Temperature obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::WeatherApp2.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::WeatherApp2.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::WeatherApp2.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_WeatherEachDays(global::System.Collections.ObjectModel.ObservableCollection<global::WeatherApp2.Models.DailyForecast> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_WeatherEachHours(global::System.Collections.ObjectModel.ObservableCollection<global::WeatherApp2.Models.WeatherJSON> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
